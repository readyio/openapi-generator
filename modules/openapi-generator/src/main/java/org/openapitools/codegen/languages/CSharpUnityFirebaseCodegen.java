...
public class CSharpUnityFirebaseCodegen extends AbstractCSharpCodegen {
    @SuppressWarnings("hiding")
    private final Logger LOGGER = LoggerFactory.getLogger(CSharpUnityFirebaseCodegen.class);
    ...
    public CSharpUnityFirebaseCodegen() {
        super();
    ...
    public String getName() {
        return "csharp-unity-firebase";
    }

    @Override
    public String getHelp() {
        return "Generates a CSharp Unity Firebase Cloud Functions client library.";
    }
